...
class ContextWrapper {
 public:
  ...
  Status CreateWithModules(InstanceWrapper instance_wrapper,
                           std::vector<ModuleWrapper*> module_wrappers);

  Status RegisterModules(std::vector<ModuleWrapper*> module_wrappers);
